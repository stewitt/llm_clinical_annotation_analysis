...
Inference pipeline: Runs free-text colonoscopy reports through local LLMs, extracts structured lesion data (diameter, location, resection type), normalizes and maps outputs to canonical categories
